...
foreach(_cmake_expected_target IN ITEMS track::track)
...
# Create imported target track::track
add_library(track::track SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/trackConfig-*.cmake")
